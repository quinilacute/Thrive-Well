        ...
        {reviews.map(({ name, text }, index) => (
          ...
          >
            <div className="max-w-[75%]">
              <h3 className="text-l font-semibold mb-1 text-gray-900">{name}</h3>
              <p className="text-gray-700 text-1">{text}</p>
            </div>
            <img src={word} alt="Quote" className="w-5 h-5 object-contain" />
          </div>
        ))}
      </div>
    </div>
